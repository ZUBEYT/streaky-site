        ...
        <div className="min-h-screen bg-gradient-to-b from-purple-900 via-purple-800 to-indigo-900 text-white py-32 px-8">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20">
                {CHALLENGES.map((challenge) => (
                    <div
                        key={challenge.id}
                        className="bg-white/20 p-12 rounded-3xl backdrop-blur shadow-2xl flex flex-col h-full"
                        style={{ borderLeft: `10px solid ${challenge.color}` }}
                    >
                        <div className="text-center flex-grow">
                            <div className="text-9xl mb-8">{challenge.icon}</div>
                            <h3 className="text-4xl font-bold mb-6">{challenge.title}</h3>
                            <p className="text-xl leading-relaxed mb-12 opacity-90">{challenge.description}</p>
                            ...
                            <p className="text-xl opacity-90">
                                Winners share 75% of the prize pool!
                            </p>
                        </div>

                        <div className="text-center mt-auto pt-8">
                            <div className="bg-white/30 text-white px-16 py-8 rounded-full text-3xl font-bold cursor-not-allowed opacity-70 inline-block">
                                Coming Soon
                            </div>
                        </div>
                    </div>
