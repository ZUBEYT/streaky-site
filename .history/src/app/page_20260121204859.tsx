    ...
    <div className="max-w-6xl mx-auto p-8">
      ...
      <div className="text-center my-16">
        ...
        <div className="flex justify-center gap-8">
          <Link href="#" className="bg-purple-600 text-white px-8 py-4 rounded-full text-xl font-bold hover:bg-purple-700">Download on App Store</Link>
          <Link href="#" className="bg-purple-600 text-white px-8 py-4 rounded-full text-xl font-bold hover:bg-purple-700">Download on Google Play</Link>
        </div>
      </div>
